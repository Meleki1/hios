...
from hios.api.main import app
from hios.api.dependencies import get_home_assistant_chat
from hios.capabilities.assistant.chat import HomeAssistantChat
...
def test_main_app_chat_endpoint():
    ...
    assert data["message"] == "Hello from Home Assistant."
